...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'bower_components/angular-xregexp/angular-xregexp.js',
      'bower_components/ng-country-select/dist/ng-country-select.js',
      'bower_components/angular-countries/dist/angular-data-service.js',
      'bower_components/bootstrap/dist/js/bootstrap.js',
      'bower_components/CountrySelecter/js/app.js',
      'bower_components/angular-websocket/dist/angular-websocket.js',
      'bower_components/angular-socket-io/socket.js',
      'bower_components/moment/moment.js',
      'bower_components/angular-moment/angular-moment.js',
      'bower_components/d3/d3.js',
      'bower_components/epoch/dist/js/epoch.min.js',
